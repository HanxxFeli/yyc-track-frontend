...
const StationFilter = ({ onFilterChange, isAuthenticated = false}) => { 
    ...
    return ( 
        <div className="w-full max-w-[320px] bg-white rounded-lg shadow-lg p-6">
            {/* Header */}
            ...
            {!isAuthenticated && (
                ...
                <div className="flex gap-2">
                    ...
                    <button className="flex-1 px-4 py-2 bg-white bg-[#BC0B2A] text-sm font-semibold rounded-md border border-red-600 hover:bg-red-50 transition-colors">
                    Register
                    </button>
                </div>
                </div>
